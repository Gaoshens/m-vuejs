...
importers:
  ...
  .:
    ...
    devDependencies:
      ...
      '@commitlint/cli': 17.4.4
      '@commitlint/config-conventional': 17.4.4
      '@rollup/plugin-babel': 6.0.3_qfvff2iu6b2qa5c3eagnq2qwte
      '@rollup/plugin-commonjs': 13.0.2_rollup@3.17.3
      '@rollup/plugin-json': 6.0.0_rollup@3.17.3
      '@rollup/plugin-node-resolve': 13.0.6_rollup@3.17.3
      ...
      prettier: 2.8.4
      rollup: 3.17.3
      rollup-plugin-node-resolve: 5.2.0_rollup@3.17.3
      rollup-plugin-terser: 7.0.2_rollup@3.17.3
      rollup-plugin-typescript2: 0.34.1_5h3uv6h5hdci4akcbsseut5pjq
      typescript: 4.9.5
...
packages:
  ...
  /@commitlint/load/17.4.4:
    ...
    dependencies:
      ...
      chalk: 4.1.2
      cosmiconfig: 8.1.0
      cosmiconfig-typescript-loader: 4.3.0_r66scxackjdo2gfsj5qbvkw6ay
  ...
  /@rollup/plugin-commonjs/13.0.2_rollup@3.17.3:
    ...
    peerDependencies:
      rollup: ^2.3.4
    dependencies:
      '@rollup/pluginutils': 3.1.0_rollup@3.17.3
      commondir: 1.0.1
      estree-walker: 1.0.1
      glob: 7.2.3
      is-reference: 1.2.1
  ...
  /execa/4.0.2:
    resolution: {integrity: sha512-QI2zLa6CjGWdiQsmSkZoGtDx2N+cQIGb3yNolGTdjSQzydzLgYYf8LRuagp7S7fPimjcrzUDSUFd/MgzELMi4Q==}
    engines: {node: '>=10'}
    dependencies:
      cross-spawn: 7.0.3
      get-stream: 5.2.0
